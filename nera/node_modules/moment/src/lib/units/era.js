...
import { addRegexToken, matchUnsigned, regexEscape } from 'moment/src/lib/parse/regex';
import { addParseToken } from 'moment/src/lib/parse/token';
import { YEAR } from 'moment/src/lib/units/constants';
import { hooks as moment } from 'moment/src/lib/utils/hooks';
import { getLocale } from 'moment/src/lib/locale/locales';
import getParsingFlags from 'moment/src/lib/create/parsing-flags';
import hasOwnProp from 'moment/src/lib/utils/has-own-prop';
