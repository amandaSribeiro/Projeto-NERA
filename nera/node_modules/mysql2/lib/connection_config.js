...
const ClientConstants = require('mysql2/lib/constants/client');
const Charsets = require('mysql2/lib/constants/charsets');
const { version } = require('mysql2/package.json')
...
class ConnectionConfig {
  ...
  static getSSLProfile(name) {
    if (!SSLProfiles) {
      SSLProfiles = require('mysql2/lib/constants/ssl_profiles.js');
    }
