...
const ConnectionManager = require("sequelize/lib/dialects/db2/connection-manager");
const Query = require("sequelize/lib/dialects/db2/query");
const QueryGenerator = require("sequelize/lib/dialects/db2/query-generator");
const DataTypes = require("sequelize/lib/data-types").db2;
const { Db2QueryInterface } = require("sequelize/lib/dialects/db2/query-interface");
