...
const ConnectionManager = require("sequelize/lib/dialects/mssql/connection-manager");
...
const DataTypes = require("sequelize/lib/data-types").mssql;
const { MSSqlQueryInterface } = require("sequelize/lib/dialects/mssql/query-interface");
