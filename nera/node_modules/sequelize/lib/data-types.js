...
const dialectMap = {};
dialectMap.postgres = require("sequelize/lib/dialects/postgres/data-types")(DataTypes);
dialectMap.mysql = require("sequelize/lib/dialects/mysql/data-types")(DataTypes);
dialectMap.mariadb = require("sequelize/lib/dialects/mariadb/data-types")(DataTypes);
dialectMap.sqlite = require("sequelize/lib/dialects/sqlite/data-types")(DataTypes);
dialectMap.mssql = require("sequelize/lib/dialects/mssql/data-types")(DataTypes);
dialectMap.db2 = require("sequelize/lib/dialects/db2/data-types")(DataTypes);
dialectMap.snowflake = require("sequelize/lib/dialects/snowflake/data-types")(DataTypes);
dialectMap.oracle = require("sequelize/lib/dialects/oracle/data-types")(DataTypes);
